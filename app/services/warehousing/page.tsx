...
export default function WarehousingPage() {
  return (
    <main className="px-0">
      <NavHeightObserver />
      <PageHero title={"Warehousing"} subtitle={"Storage, consolidation and value‑added services across regions."} image={WarehouseImg} imageAlt="Distribution warehouse interior" />
      <div className="mx-auto max-w-7xl px-6 py-12 space-y-8">
      <nav className="text-sm text-neutral-600 dark:text-neutral-400"><Link href="/services" className="hover:underline">Services</Link> / Warehousing</nav>
      ...
      <section className="grid gap-4">
        ...
        <ul className="list-disc pl-5 space-y-1 text-sm text-neutral-700 dark:text-neutral-300">
          ...
          <li>Pick, pack and labeling</li>
          <li>Bonded and temperature‑controlled facilities</li>
          <li>Consolidation and cross‑dock</li>
        </ul>
      </section>
      ...
      <section className="rounded-xl border border-neutral-200/70 dark:border-neutral-800/70 p-6 bg-neutral-50 dark:bg-neutral-950">
        <h3 className="font-medium">Plan your storage</h3>
        <p className="mt-1 text-sm text-neutral-600 dark:text-neutral-400">Scale up and down with flexible warehousing.</p>
